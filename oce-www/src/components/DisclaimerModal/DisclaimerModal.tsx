...
const DisclaimerModal: React.FC<DisclaimerModal> = ({ onConfirm, onDismiss }) => {
  ...
  const modalContent = useMemo(() => {
    if (step === 'disclaimer') {
      ...
      return (
        <div>
          <p>Attention OCE Uniswap LPs</p>
          <p>The only Uniswap pool that is compatible with OCE is OCE/yCRV (Curve yPool tokens)</p>
